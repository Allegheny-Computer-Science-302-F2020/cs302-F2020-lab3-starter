...
* [Laboratory Assignment Tasks](#laboratory-assignment-tasks)
  + [Create a Multiple-Page Travel Photographs Web Site](#create-a-multiple-page-travel-photographs-web-site)
...
`Allegheny-Computer-Science-302-Fall-2020/computer-science-302-fall-2020-lab-3-gkapfham`.
...
```
git clone git@github.com:Allegheny-Computer-Science-302-F2020/computer-science-302-fall-2020-lab-3-gkapfham.git
```
...
### Create a Multiple-Page Travel Photographs Web Site
...
repository. As in a previous assignment, to start this web development project,
you will need to include the cascading style sheet (CSS) that controls, for
instance, the fonts on the web site. You can achieve this step by adding the
code `<link href="css/github.css" rel="stylesheet">` to the `<head>` region of
the `src/www/index.html` file. Note that you also need to have another line of
source code to load the `emoji.css` file and its features for including an emoji
in a web site. How would you write that line of HTML source code? To get started
you can refer to the following example of how to include the two required CSS
files in your `src/www/index.html` file in the following code segment:
...
This laboratory assignment invites you to create an `index.html` file that makes
a reference to two other files called `about.html` and `software.html`. As part
of this assignment you will also explore how to create unordered and ordered
lists of hypertext references. Finally, you are going to learn how to use the
`target="_blank"` addition to a hypertext reference to make a link open in a new
tab of your browser. Ultimately, you are going to create segments of HTML that
contain the following type of content:

- An unordered list containing links that open in the same browser tab
- An ordered list containing links that open in the same browser tab
- An unordered list containing links that open in a different browser tab
- An ordered list containing links that open in a different browser tab

For instance, here is an example of the required HTML source code that can make
the unordered list that contains links that will open in a different browser
tab.

```
<h3>Unordered List (New Tab)</h3>
...
Please follow the `TODO` markers inside of the `index.html` file as you add all
of the required source code to the `index.html` file. For instance, you will
need to add the three other list segments along with the list segment provided
in the above code block. As you are working, make sure that you run the
...
127.0.0.1 - - [22/Sep/2020 13:22:44] "GET / HTTP/1.1" 200 -
127.0.0.1 - - [22/Sep/2020 13:22:46] "GET /software.html HTTP/1.1" 200 -
```
...
- The about.html in src/www/ has exactly 0 of the `Add Your Name Here` fragment
- The about.html in src/www/ has exactly 0 of the `TODO` fragment
- The command `htmlhint src/www/*.html` executes correctly
- The command output has exactly 1 lines
- The file about.html exists in the src/www/ directory
- The file index.html exists in the src/www/ directory
- The file reflection.md exists in the writing directory
- The file software.html exists in the src/www/ directory
...
- The index.html in src/www/ has at least 4 of the `_blank` fragment
- The index.html in src/www/ has at least 8 of the `a href` fragment
...
- The repository has at least 5 commit(s)complete!
- The software.html in src/www/ has exactly 0 of the `Add Your Name Here` fragment
- The software.html in src/www/ has exactly 0 of the `TODO` fragment

```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 32/32 (100%) of checks for cs302-F2020-lab3! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-302-F2020/cs302-F2020-lab3-starter/
```
